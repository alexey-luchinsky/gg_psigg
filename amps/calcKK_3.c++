...
void calc_KK_3() {
	 abbr[30]=abbr[27]*pow(MC,0.5)*pow(6*PI,-0.5)*pow(abbr[28],-1)*pow(abbr[29],-1);
	 ...
	 abbr[32]=abbr[31]*pow(MC,0.5)*pow(6*PI,-0.5)*pow(abbr[28],-1)*pow(abbr[29],-1);
	 ...
	 abbr[34]=abbr[33]*pow(MC,0.5)*pow(6*PI,-0.5)*pow(abbr[28],-1)*pow(abbr[29],-1);
	 ...
	 abbr[36]=abbr[35]*pow(MC,0.5)*pow(6*PI,-0.5)*pow(abbr[28],-1)*pow(abbr[29],-1);
