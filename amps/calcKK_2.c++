...
void calc_KK_2() {
	 abbr[20]=abbr[17]*pow(abbr[18],-1)*pow(abbr[19],-1)*pow(pow(MC,-1),-0.5);
	 ...
	 abbr[22]=abbr[21]*pow(abbr[18],-1)*pow(abbr[19],-1)*pow(pow(MC,-1),-0.5);
	 ...
	 abbr[24]=abbr[23]*pow(abbr[18],-1)*pow(abbr[19],-1)*pow(pow(MC,-1),-0.5);
