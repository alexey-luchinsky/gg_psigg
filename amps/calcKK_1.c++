...
void calc_KK_1() {
	 ...
	 abbr[11]=abbr[10]*pow(abbr[2],-1)*pow(abbr[3],-1)*pow(pow(MC,-1),-0.5);
	 abbr[12]=-2*k1k3 - 2*k1k4 + s;
	 abbr[13]=abbr[1]*pow(abbr[2],-1)*pow(abbr[12],-1)*pow(pow(MC,-1),-0.5);
	 abbr[14]=abbr[7]*pow(abbr[2],-1)*pow(abbr[12],-1)*pow(pow(MC,-1),-0.5);
	 abbr[15]=abbr[10]*pow(abbr[2],-1)*pow(abbr[12],-1)*pow(pow(MC,-1),-0.5);
